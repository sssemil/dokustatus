...
import { AlertTriangle, Loader2, CheckCircle, CreditCard, TestTube } from 'lucide-react';
...
type ModalState = 'select_scenario' | 'processing' | 'requires_confirmation' | 'success' | 'error';
...
export function DummyCheckoutModal({
  ...
  const handleCheckout = async () => {
    ...
    try {
      const res = await fetch(`/api/public/domain/${apiDomain}/billing/checkout/dummy`, {
        method: 'POST',
        headers: {
  ...
  const handleConfirm3DS = async () => {
    ...
    try {
      const res = await fetch(`/api/public/domain/${apiDomain}/billing/dummy/confirm`, {
        method: 'POST',
        headers: {
          'Content-Type': 'application/json',
        },
        ...
        return (
          <div className="space-y-4">
            ...
            <div className="flex items-center gap-2 p-3 bg-zinc-800/50 rounded-lg border border-zinc-700">
              ...
              <div>
                <p className="text-sm font-medium text-white">Test Payment Provider</p>
                <p className="text-xs text-zinc-400">This is a simulated payment for testing purposes</p>
              </div>
            </div>
            ...
            <div className="p-4 bg-zinc-800/50 rounded-lg border border-zinc-700">
              ...
              <p className="text-2xl font-bold text-white">
                ...
                <span className="text-sm font-normal text-zinc-400">
                  /{plan.interval_count === 1 ? plan.interval.replace('ly', '') : `${plan.interval_count} ${plan.interval}`}
                </span>
              </p>
            </div>
            ...
            <div className="space-y-2">
              ...
              <p className="text-sm text-zinc-400">{getScenarioDescription(scenario)}</p>
            </div>
              ...
              <div className={`p-3 rounded-lg border ${
                ...
                <div className="flex items-center gap-2">
                  <AlertTriangle className={`w-4 h-4 ${
                    scenario === 'three_d_secure' ? 'text-blue-400' : 'text-yellow-400'
                  }`} />
                  <span className={`text-sm font-medium ${
                    scenario === 'three_d_secure' ? 'text-blue-300' : 'text-yellow-300'
                  }`}>
                    {scenario === 'three_d_secure'
          ...
          <div className="space-y-4">
            <div className="p-4 bg-blue-500/10 border border-blue-500/30 rounded-lg">
              <div className="flex items-center gap-2 mb-2">
                ...
                <span className="font-medium text-blue-300">3D Secure Authentication Required</span>
              </div>
              <p className="text-sm text-zinc-300">
                This payment requires additional authentication. In a real scenario,
                the user would be redirected to their bank's authentication page.
              </p>
            ...
            <div className="flex gap-3">
              ...
              <Button variant="primary" onClick={handleConfirm3DS} className="flex-1">
        ...
        return (
          <div className="space-y-4">
            <div className="p-4 bg-green-500/10 border border-green-500/30 rounded-lg text-center">
              ...
              <p className="font-medium text-green-300">Test payment successful!</p>
